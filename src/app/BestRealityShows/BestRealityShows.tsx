...
import dataBestReailtyShows from "./bestrealityshows.json";
      ...
      <div className=" mt-12">
        ...
        <div className="w-full m-auto mt-8">
          <div className="w-11/12 m-auto ">
            <Slider {...settings}>
              {dataBestReailtyShows.map((reality) => (
                <div
                  key={reality.id}
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      handleClickOpenModalOnImageClick(reality.links_new)
                    }
